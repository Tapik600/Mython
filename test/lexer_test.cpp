...
"another \"long\" string with double quote \" inside"
"another 'long' string with single quote ' inside"
'another \'long\' string with single quote \' inside'
"another \tlong string with tab \t inside"
"another \nlong string with new line \n inside"
    ...
    ASSERT_EQUAL(lexer.NextToken(), Token(token_type::String{
                                        "another \"long\" string with double quote \" inside"s}));
    ASSERT_EQUAL(lexer.NextToken(), Token(token_type::Newline{}));
    ASSERT_EQUAL(lexer.NextToken(),
    ...
    ASSERT_EQUAL(lexer.NextToken(), Token(token_type::Newline{}));
    ASSERT_EQUAL(lexer.NextToken(),
                 Token(token_type::String{"another \tlong string with tab \t inside"s}));
    ASSERT_EQUAL(lexer.NextToken(), Token(token_type::Newline{}));
    ASSERT_EQUAL(lexer.NextToken(),
                 Token(token_type::String{"another \nlong string with new line \n inside"s}));
}
