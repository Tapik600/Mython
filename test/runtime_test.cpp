...
void TestMethodInvocation() {
    ...
    child_methods.push_back({"test"s,
                             {"arg1_child"s, "arg2_child"s},
                             make_unique<TestMethodBody>(child_method_1)});
    ...
    ASSERT(Equal(child_closure.at("arg1_child"s), (ObjectHolder::Own(String{"value1"s})),
                 context));
    ASSERT_EQUAL(child_closure.count("arg2_child"s), 1U);
    ASSERT(Equal(child_closure.at("arg2_child"s), (ObjectHolder::Own(String{"value2"s})),
                 context));
...
void TestComparison() {
    auto test_equal = [](const ObjectHolder &lhs, const ObjectHolder &rhs,
    ...
    auto test_greater = [](const ObjectHolder &lhs, const ObjectHolder &rhs,
                           bool greater_result) {
        DummyContext ctx;
    ...
    // Strings
    {
        ...
        test_equal(ObjectHolder::Own(String{"Hello"s}), ObjectHolder::Own(String{"Hello"s}),
                   true);
        test_equal(ObjectHolder::Own(String{"Hello"s}), ObjectHolder::Own(String{"hello"s}),
                   false);
        ...
        test_greater(ObjectHolder::Own(String{"abc"s}), ObjectHolder::Own(String{"abb"s}),
                     true);
        test_greater(ObjectHolder::Own(String{""s}), ObjectHolder::Own(String{""s}), false);
        test_greater(ObjectHolder::Own(String{"abc"s}), ObjectHolder::Own(String{"abc"s}),
                     false);
        test_greater(ObjectHolder::Own(String{"abb"s}), ObjectHolder::Own(String{"abc"s}),
                     false);
    ...
    // Booleans
    {
        ...
        test_eq_uncomparable(ObjectHolder::Own(Bool{true}),
                             ObjectHolder::Own(String{"true"s}));
    ...
    // Class instances
    {
        ...
        auto eq_body = [&eq_closure, &eq_result](Closure &closure,
        ...
        auto lt_body = [&lt_closure, &lt_result](Closure &closure,
                                                 [[maybe_unused]] Context &ctx) {
            lt_closure = closure;
            return lt_result;
        };
        ...
        cls1_methods.push_back(
            {"__eq__"s, {"rhs"s}, std::make_unique<TestMethodBody>(eq_body)});
        cls1_methods.push_back(
            {"__lt__"s, {"rhs"s}, std::make_unique<TestMethodBody>(lt_body)});
